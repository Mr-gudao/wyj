...
public class Email {
	...
	private static String sendAddr = "13995992152";
	private static String receiveAddr = "3487232393";

	//这个不是密码,是开启163邮箱第三方登录时候设置的授权码
	//如果不开启,那么是无法第三方登录163邮箱账号的
	private static String pass = "rxq577665";


	public static void t1(Inactive_user inactive_user) throws MessagingException {
...
//		prop.put("mail.transport.protocol", "smtp");
		...
		//设置收件人
		msg.setRecipients(Message.RecipientType.TO,inactive_user.getInactive_userEmail());
...
//		msg.setRecipients(Message.RecipientType.BCC,"偷偷的发@163.com");
		...
		//添加主题
		msg.setSubject("这是来自唯一家的邮件");

		//添加内容,第二个参数表示这是html的内容
		msg.setContent("唯一家注册验证码:"+inactive_user.getCode(),"text/html;charset=utf-8");
